  ...
  return (
    <div className="animate-fade-up">
      <div className="flex items-center justify-between">
        <div>
          <p className="font-sans text-[10px] tracking-[0.2em] uppercase text-primary/40">Configuration</p>
          <h1 className="mt-1 text-2xl font-bold text-foreground">Platform Settings</h1>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
          className={`rounded-lg border px-5 py-2 font-sans text-xs font-medium transition-all disabled:opacity-50 ${
            saved
      ...
      <div className="mt-8 space-y-8">
        <section>
          <h2 className="font-sans text-[10px] tracking-[0.2em] uppercase text-muted-foreground/50 mb-3">Feature Flags</h2>
        ...
        <section>
          <h2 className="font-sans text-[10px] tracking-[0.2em] uppercase text-muted-foreground/50 mb-3">Limits</h2>
          <div className="space-y-2">
            <div className="flex items-center justify-between rounded-lg border border-border/30 bg-card/20 px-4 py-3">
              ...
              <input
                ...
                className="w-20 rounded-md border border-border/30 bg-background/50 px-3 py-1 text-right font-sans text-xs text-foreground focus:outline-none focus:border-primary/30"
              />
            </div>
            <div className="flex items-center justify-between rounded-lg border border-border/30 bg-card/20 px-4 py-3">
        ...
        <section>
          <h2 className="font-sans text-[10px] tracking-[0.2em] uppercase text-muted-foreground/50 mb-3">Maintenance</h2>
          <div className="space-y-2">
            ...
            {settings.maintenanceMode && (
              <div className="rounded-lg border border-destructive/20 bg-card/20 px-4 py-3">
                <label className="font-sans text-[10px] tracking-wider uppercase text-destructive/50">
                  Maintenance message
                </label>
                <input
                  type="text"
                  ...
                  className="mt-1.5 w-full rounded-md border border-border/30 bg-background/50 px-3 py-2 font-sans text-xs text-foreground placeholder:text-muted-foreground/30 focus:outline-none focus:border-destructive/30"
                />
              </div>
            )}
          </div>
