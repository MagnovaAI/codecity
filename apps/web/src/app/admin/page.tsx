    ...
    <div className="space-y-8 animate-fade-up">
        ...
        {stats.map((stat) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-[9px] tracking-wider text-muted-foreground/30">
                {stat.tag}
              </span>
            </div>
      ...
      <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-5">
        <p className="text-xs text-amber-400">
          Database not connected. Configure <code className="font-mono">@codecity/db</code> to see live admin data.
        </p>
      </div>
    </div>
  )
